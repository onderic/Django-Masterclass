...
class GetPaginatedResponseTests(TestCase):
    def setUp(self):
        ...
        self.user1 = user_create(email="onderi1@gmail.com")
        self.user2 = user_create(email="onderi2@gmail.com")

    def test_response_is_paginated_correctly(self):
        first_page_request = self.factory.get("/some/path")
        first_page_response = ApiList.as_view()(first_page_request)
        ...
        next_page_response = ApiList.as_view()(next_page_request)
