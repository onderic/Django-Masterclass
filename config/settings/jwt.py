...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "royal.authentication.services.get_jwt_scrt_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "royal.authentication.services.auth_jwt_response_payload_handler",
